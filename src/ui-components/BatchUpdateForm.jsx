...
export default function BatchUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = batchRecord
      ...
      : initialValues;
    setCpyName(cleanValues.cpyName);
    setAddress(cleanValues.address);
    setLink(cleanValues.link);
    setBatchNumber(cleanValues.batchNumber);
    setProductName(cleanValues.productName);
    setMfgDate(cleanValues.mfgDate);
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getBatch.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getBatch
        : batchModelProp;
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateBatch.replaceAll("__typename", ""),
            variables: {
              input: {
                id: batchRecord.id,
                ...modelFields,
